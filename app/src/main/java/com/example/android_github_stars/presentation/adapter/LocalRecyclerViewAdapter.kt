...
class LocalRecyclerViewAdapter(
    private val values: List<PlaceholderItem>
) : RecyclerView.Adapter<LocalRecyclerViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(binding: FragmentLocalBinding) : RecyclerView.ViewHolder(binding.root) {
